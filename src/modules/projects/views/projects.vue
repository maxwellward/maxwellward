	...
	<div class="w-full flex flex-col items-center relative mt-[3%]">
		<div class="h-fit w-5/6">
			...
			<div
				...
				<Project v-for="project in myProjects" :key="project.title" :title="project.title"
		...
		<div class="h-fit w-5/6 mt-12">
			...
			<div
				class="size-full dot-matrix xs:p-12 flex flex-wrap gap-8 xs:gap-16 w-full justify-center xs:justify-normal py-8">
				<Project v-for="project in openSourceContributions" :key="project.title" :title="project.title"
					:description="project.description" :link="project.link" />
			</div>
		</div>
	</div>
...
import { openSourceContributions, myProjects } from '@/data/projects';
</script>
